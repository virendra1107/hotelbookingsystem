...
<body class="bg-light">
   ...
   ?>
            ...
            <?php 
                    ...
                    while($room_data = mysqli_fetch_assoc($room_res))
                    {
                        ...
                        while($fea_row = mysqli_fetch_assoc($fea_q)){
                            $features_data.=" <span class='badge rounded-pill bg-light text-dark mb-3 text-wrap me-1 mb-1'>
                                $fea_row[name]
                        </span>";
                        ...
                        while($fac_row = mysqli_fetch_assoc($fac_q)){
                            $facilities_data.=" <span class='badge rounded-pill bg-light text-dark mb-3 text-wrap me-1 mb-1'>
                                $fac_row[name]
                        </span>";
                        }
    ...
    <script>
        ...
        let forgot_form = document.getElementById('recovery-form');
