                   ...
                   <form action="pay_now.php" id="booking_form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input name="checkin" onclick="check_availability()" type="date" class="form-control shadow-none" required>
                            </div>
                            <div class="col-md-6 mb-4">
                                <label class="form-label">Check-out</label>
                                <input name="checkout" onclick="check_availability()" type="date" class="form-control shadow-none" required>
                            </div>
                            <div class="col-12">
